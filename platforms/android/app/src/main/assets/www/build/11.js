...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ObLandingPageModule", function() { return ObLandingPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ob_landing__ = __webpack_require__(1761);
...
var ObLandingPageModule = /** @class */ (function () {
    function ObLandingPageModule() {
    }
    ObLandingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__ob_landing__["a" /* ObLandingPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__ob_landing__["a" /* ObLandingPage */]),
    ...
    return ObLandingPageModule;
}());

//# sourceMappingURL=ob-landing.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ObLandingPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(3);
...
var ObLandingPage = /** @class */ (function () {
    function ObLandingPage(navCtrl, navParams, store, utility, popoverCtrl, dataService) {
        ...
        this._ObLandingListner = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subscription__["Subscription"]();
        this._submitLoadingListener = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subscription__["Subscription"]();
        this._addSuccessListener = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subscription__["Subscription"]();
        this.url = "getHTMLParagraph";
        this.finalSubmit = false;
        this.submit = false;
    }
    ObLandingPage.prototype.ngOnInit = function () {
        ...
        this.loading$ = this.store.select(__WEBPACK_IMPORTED_MODULE_4__app_store__["_76" /* getObWelcomeLanding */]);
        this._submitLoadingListener = this.store.select(__WEBPACK_IMPORTED_MODULE_4__app_store__["_74" /* getObFinalSubmitLoading */]).subscribe(function (state) {
            _this.utility.updateLoader(state);
        });
        this._addSuccessListener = this.store.select(__WEBPACK_IMPORTED_MODULE_4__app_store__["_75" /* getObWElcomeState */]).subscribe(function (data) {
            if (data.finalData) {
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_4__app_store__["_0" /* ObFinalSubmitResetAction */]());
    ...
    ObLandingPage.prototype.getObWelcomeData = function () {
        var _this = this;
        var param;
        if (!this.landingType) {
            param = {
        ...
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_4__app_store__["H" /* GetObWelcomeAction */](this.url, param));
        return new Promise(function (resolve) {
            _this._ObLandingListner = _this.store.select(__WEBPACK_IMPORTED_MODULE_4__app_store__["_75" /* getObWElcomeState */])
                .subscribe(function (response) {
                _this.welcomeMessage = response.data;
                resolve();
            }, function (error) {
            });
        });
    };
    ObLandingPage.prototype.goToOBDashboard = function () {
        var _this = this;
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_4__app_store__["G" /* GetObLandingStatusAction */]('changeFirstLoginStatus'));
        this.dataService.getData('loginDetails').then(function (data) {
            data.details.userDetails.isFirstTimeLogin = false;
            _this.dataService.saveData('loginDetails', data);
        });
        this.navCtrl.setRoot('ObDashboardPage');
    };
    ObLandingPage.prototype.presentOptions = function (myEvent) {
        var popover = this.popoverCtrl.create('PopoverPage', {
            'type': 'obLanding'
        });
        popover.present({ ev: myEvent });
    };
    ObLandingPage.prototype.ionViewWillLeave = function () {
        this._ObLandingListner.unsubscribe();
        this._submitLoadingListener.unsubscribe();
        this._addSuccessListener.unsubscribe();
    };
    ObLandingPage.prototype.completeOnboarding = function () {
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_4__app_store__["Z" /* ObFinalSubmitAction */]('onboardingFinalSubmit'));
    };
    ObLandingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-ob-landing',template:/*ion-inline-start:"D:\ZenSar-Apps\ZenTalent\zenHelp\src\container\ob-landing\ob-landing.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title *ngIf="!finalSubmit">Welcome to Zensar</ion-title>\n    <ion-title *ngIf="finalSubmit">Submit</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="presentOptions($event)">\n        <ion-icon name="more"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <div class="spinner-container">\n    <ion-spinner class="loader" *ngIf="loading$ | async"></ion-spinner>\n  </div>\n\n\n  <div *ngIf="!(loading$ | async)">\n\n    <p class="obText" [innerHTML]="this.welcomeMessage?.pageText | sanitizeHtml">\n    </p>\n\n    <ion-row *ngIf="finalSubmit">\n      <ion-col col-1>\n        <ion-checkbox [(ngModel)]="submit"></ion-checkbox>\n      </ion-col>\n      <ion-col class="agreementText" col-11>I agree to all</ion-col>\n    </ion-row>\n\n    <div *ngIf="finalSubmit && submit" class="button-center">\n      <button ion-button color="light"  class="startObBtn" round (click)="completeOnboarding()">Finish Onboarding</button>\n    </div>\n\n    <div *ngIf="!finalSubmit" class="button-center">\n      <button ion-button color="light" class="startObBtn" round (click)="goToOBDashboard()">Start Onboarding</button>\n    </div>\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"D:\ZenSar-Apps\ZenTalent\zenHelp\src\container\ob-landing\ob-landing.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["y" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ngrx_store__["b" /* Store */], __WEBPACK_IMPORTED_MODULE_5__providers_commonUtilities_commonUtilities__["a" /* CommonUtilities */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["C" /* PopoverController */], __WEBPACK_IMPORTED_MODULE_6__providers_data_data__["a" /* Data */]])
    ], ObLandingPage);
    return ObLandingPage;
}());

//# sourceMappingURL=ob-landing.js.map
