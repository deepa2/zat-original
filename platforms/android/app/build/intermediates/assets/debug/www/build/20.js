...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__new_profile__ = __webpack_require__(1864);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_linky__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__img_preloader_directive__ = __webpack_require__(1865);
            ...
            this.appversion.getVersionNumber().then(function (response) {
                ...
                _this.httpProvider.http.commonService(profile).subscribe(function (response) {
                    if (response) {
                        ...
                        setTimeout(function () {
                            if (_this.slides && _this.fromHomeSkills) {
                        ...
                        setTimeout(function () {
                            if (_this.slides && _this.fromZeno) {
                                _this.slides.slideTo(3, 0);
                            }
                        }, 100);
                    }
