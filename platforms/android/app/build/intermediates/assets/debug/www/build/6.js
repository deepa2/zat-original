...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shuttles_list__ = __webpack_require__(1796);
...
var ShuttlesListPage = /** @class */ (function () {
    function ShuttlesListPage(navCtrl, navParams, utility, httpProvider) {
    ...
    ShuttlesListPage.prototype.getShuttleList = function () {
        var _this = this;
        this.isLoaderOn = true;
        this.utility.updateLoader(this.isLoaderOn);
        this.httpProvider.http.commonService({ url: "getShuttleList", data: {}, isZenAdmin: true }).subscribe(function (response) {
            _this.isLoaderOn = false;
            _this.utility.updateLoader(_this.isLoaderOn);
            if (response && !_this.utility.isEmptyOrNullOrUndefined(response.status)
                && !_this.utility.isEmptyOrNullOrUndefined(response.status.statusCode) && response.status.statusCode == 1) {
                if (!_this.utility.isEmptyOrNullOrUndefined(response["data"])) {
                    _this.shuttleList = response["data"];
                }
            }
        }, function (error) {
            _this.isLoaderOn = false;
