...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExitFaqPageModule", function() { return ExitFaqPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__exit_faq__ = __webpack_require__(1545);
...
var ExitFaqPageModule = /** @class */ (function () {
    function ExitFaqPageModule() {
    }
    ExitFaqPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__exit_faq__["a" /* ExitFaqPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__exit_faq__["a" /* ExitFaqPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4__pipes_pipes_module__["a" /* PipesModule */]
            ],
        })
    ], ExitFaqPageModule);
    return ExitFaqPageModule;
}());

//# sourceMappingURL=exit-faq.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExitFaqPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(3);
 ...
 */
var ExitFaqPage = /** @class */ (function () {
    function ExitFaqPage(navCtrl, navParams, http, utility) {
    ...
    ExitFaqPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        this.http.http.commonService(param).subscribe(function (response) {
            ...
            if (response && response.details) {
                ...
                _this.faqData = response.details;
                _this.faqCopy = _this.faqData;
            }
        }, function (error) {
            _this.utility.updateLoader(false);
        });
    };
    ExitFaqPage.prototype.askQuestion = function () {
        this.navCtrl.push('AddPage', { 'type': 'addQuestion', 'questionId': null, 'answerType': null });
    };
    ExitFaqPage.prototype.updateFilter = function () {
        var _this = this;
        this.faqData = this.faqCopy;
        if (this.searchText != '' && this.searchText != null) {
            this.faqData = this.faqData.filter(function (value) {
                if ((value.question.toLowerCase().includes(_this.searchText.toLowerCase())) || (value.answer.toLowerCase().includes(_this.searchText.toLowerCase())))
                    return value;
            });
        }
    ...
    ExitFaqPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-exit-faq',template:/*ion-inline-start:"D:\ZenSar-Apps\ZenTalent\zenHelp\src\container\Exit-Module\exit-faq\exit-faq.html"*/'<!--\n  Generated template for the ExitFaqPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>FAQs</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n  <div *ngIf="faqData">\n    <div>\n      <div class="faq-conatiner">\n        <span class="faq-conatiner-left">\n          {{faqDetails?.text}}\n        </span>\n        <span class="faq-conatiner-right">\n          <img src="assets/ZenExit-Imgs/faq-item.svg">\n        </span>\n      </div>\n      <div class="search-container">\n        <span class="search-box">\n          <ion-icon name="search" item-left></ion-icon>\n          <input class="input-props" type="text" placeholder="Search here" [(ngModel)]="searchText"\n            (ngModelChange)="updateFilter(faqData)">\n        </span>\n      </div>\n    </div>\n    <div>\n      <ion-list>\n        <accordian *ngFor="let faqDetails of faqData" [faqData]="faqDetails" [type]="type"></accordian>\n      </ion-list>\n      <div class="no-data" *ngIf="faqData.length == 0">No query found</div>\n      <div class="faq-bottom">\n        <span class="faq-text">\n          Still did not find the relevent information? Need Help?\n        </span>\n      </div>\n      <span (click)="askQuestion()" class="faq-bottom-conatiner">\n        <img style="margin-right: 5px" src="assets/ZenExit-Imgs/mind.svg">\n        <span class="text-style">Ask a question</span>\n      </span>\n    </div>\n  </div>\n\n\n</ion-content>'/*ion-inline-end:"D:\ZenSar-Apps\ZenTalent\zenHelp\src\container\Exit-Module\exit-faq\exit-faq.html"*/,
        }),
...
//# sourceMappingURL=exit-faq.js.map
